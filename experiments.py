...
def run_experiment(run_name, out_dir='./results', seed=None,
    ...
    out_classes = 10
    filters = [k for k in filters_per_layer for _ in range(layers_per_block)]
    ...
    fit_res = trainer.fit(dl_train, dl_test, epochs, early_stopping=early_stopping, print_every=2)
    # ========================
